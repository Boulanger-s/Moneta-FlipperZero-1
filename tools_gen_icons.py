#!/usr/bin/env python3
"""Generate the 1-bit 10x10 Flipper app icon for Moneta from an ASCII bitmap.
...
GLYPHS = {
    # App mark: a payment card, chip on the left, leaking a contactless wave
    # off its right edge. The wave is the whole point of the application, so
    # it gets a third of the ten pixels available.
    "moneta_10px": [
        "..........",
        ".#######..",
        ".#.....#.#",
